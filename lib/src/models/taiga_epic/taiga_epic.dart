...
import 'package:taiga_rest_models/src/models/taiga_epic/data/taiga_epic_data.dart';

/// This Class class is a model for map a Taiga payload from the webhook of
/// Taiga (Came as Json Format)
class TaigaEpic {
  /// Constructor of TaigaEpic
  TaigaEpic({
  ...
  /// Mapper of the TaigaEpic class
  factory TaigaEpic.fromJson(Map<String, dynamic> json) {
    return TaigaEpic(
