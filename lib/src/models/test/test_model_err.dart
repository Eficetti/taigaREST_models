...
class Attachments {
    ...
    factory Attachments.fromJson(Map<String, dynamic> json){ 
        return Attachments(
            attachmentsNew: json["new"] == null ? [] : List<New>.from(json["new"]!.map((x) => New.fromJson(x))),
            changed: json["changed"] == null ? [] : List<dynamic>.from(json["changed"]!.map((x) => x)),
...
class Data {
    ...
    factory Data.fromJson(Map<String, dynamic> json){ 
        return Data(
            customAttributesValues: json["custom_attributes_values"] == null ? null : CustomAttributesValues.fromJson(json["custom_attributes_values"]),
            id: json["id"],
            ref: json["ref"],
            ...
            dueDateReason: json["due_date_reason"],
            subject: json["subject"],
            externalReference: json["external_reference"],
            watchers: json["watchers"] == null ? [] : List<dynamic>.from(json["watchers"]!.map((x) => x)),
            description: json["description"],
            tags: json["tags"] == null ? [] : List<dynamic>.from(json["tags"]!.map((x) => x)),
            permalink: json["permalink"],
            project: json["project"] == null ? null : Project.fromJson(json["project"]),
            milestone: json["milestone"],
            owner: json["owner"] == null ? null : By.fromJson(json["owner"]),
            assignedTo: json["assigned_to"] == null ? null : By.fromJson(json["assigned_to"]),
            status: json["status"] == null ? null : Status.fromJson(json["status"]),
            type: json["type"] == null ? null : Priority.fromJson(json["type"]),
            priority: json["priority"] == null ? null : Priority.fromJson(json["priority"]),
            severity: json["severity"] == null ? null : Priority.fromJson(json["severity"]),
            promotedTo: json["promoted_to"] == null ? [] : List<dynamic>.from(json["promoted_to"]!.map((x) => x)),
        );
    }
