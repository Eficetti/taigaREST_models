...
class _$TaskImpl implements _Task {
  ...
  @override
  String toString() {
    return 'Task(type: $type, date: $date, action: $action, data: $data, by: $by, change: $change)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, type, date, action, data, by, change);
...
abstract class _Task implements Task {
  const factory _Task(
      ...
      final Change? change}) = _$TaskImpl;
