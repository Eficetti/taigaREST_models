...
///  all the data of the User on taiga
class TaigaUser {
  ...
  /// Mapper of the TaigaUser Class
  factory TaigaUser.fromJson(Map<String, dynamic> json) {
    return TaigaUser(
      id: json['id'] as int,
  ...
  /// TaigaUsername of the user related on Taiga
  String username;
